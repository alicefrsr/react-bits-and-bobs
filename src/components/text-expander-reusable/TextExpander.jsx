      ...
      <ul className={styles.demos}>
        <li className={styles.demo}>
          ...
          <div className={styles.code}>
            <p style={{ fontWeight: 'bold', fontFamily: 'Helvetica Neue' }}>
              The following props can be passed to the component to customise
              it. Default values apply when props are omitted:
            </p>
        ...
        <li className={styles.demo}>
          ...
          <TextExpander expanded={true}>
            ...
            easy (or cheap), the results are out of this world. Think about the
            first time humans stepped foot on the moon or when rovers were sent
            to roam around on Mars.
          </TextExpander>
        </li>
      </ul>
    </div>
...
const TextExpander = ({
  ...
  return (
    <div className={`${styles.card}`}>
      <p>{displayText}</p>
      <button style={buttonStyle} onClick={handleCollapse}>
