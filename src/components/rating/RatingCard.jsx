    ...
    <div>
      <CardBg>
        ...
        <p className={styles.text}>
          ...
          is appreciated to improve our service!
        </p>
        ...
        <div className={styles.btns}>
          <button
            ...
            className={
              selectedRatings.oneStar
                ? `${styles.btnCircle} ${styles.active}`
                : `${styles.btnCircle}`
            }
            onClick={() => {
              setSelectedRatings({
